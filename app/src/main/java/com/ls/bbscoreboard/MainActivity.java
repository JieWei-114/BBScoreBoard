...
public class MainActivity extends AppCompatActivity {
    Button btnbad,btnbas,btnhis,btnexit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnbas = findViewById(R.id.butbas);
        btnbad = findViewById(R.id.butbad);
        btnhis = findViewById(R.id.buthis);
        ...
        btnbad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, Badminton.class);
                startActivity(i);
                finish();
            }
        });
